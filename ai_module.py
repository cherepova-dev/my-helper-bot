...
═══════════════════════════════════
Если пользователь просит записать, добавить, запиши, сделай задачу, поставь задачу, нужно сделать — это ВСЕГДА type: "task" (или "tasks" для нескольких).
Ключевые признаки задачи: «запиши», «добавь», «нужно», «надо», «сделать», «купить», «позвонить», «записаться», «заказать», «написать [кому-то]», «забрать», «отвезти», «приготовить» и т.п.
НИКОГДА не используй type: "chat" если пользователь даёт поручение или описывает дело — даже если формулировка сложная или нечёткая. В таких случаях извлеки задачу и используй type: "task".
